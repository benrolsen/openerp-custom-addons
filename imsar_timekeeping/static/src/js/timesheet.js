...
openerp.hr_timekeeping_sheet = function(instance) {
    var QWeb = instance.web.qweb;
    var _t = instance.web._t;

    instance.hr_timekeeping_sheet.WeeklyTimesheet = instance.web.form.FormWidget.extend(instance.web.form.ReinitializeWidgetMixin, {
        events: {
        ...
        display_data: function() {
            var self = this;
            self.$el.html(QWeb.render("hr_timekeeping_sheet.WeeklyTimesheet", {widget: self}));
    ...
    instance.web.form.custom_widgets.add('weekly_timesheet', 'instance.hr_timekeeping_sheet.WeeklyTimesheet');
