...
class account_invoice_line(osv.osv):
    ...
    def move_line_get(self, cr, uid, invoice_id, context=None):
        ...
        def get_price(cr, uid, inv, company_currency,i_line):
            ...
            unit_price = i_line.product_id.standard_price
            
            if inv.currency_id.id != company_currency:
                price = cur_obj.compute(cr, uid, company_currency, inv.currency_id.id, unit_price * i_line.quantity, context={'date': inv.date_invoice})
            else:
                price = unit_price * i_line.quantity
            return price
