...
class stock_move_matching(osv.osv):
    ...
    _columns = {
        ...
        'price_unit':fields.related('move_in_id', 'price_unit', digits_compute= dp.get_precision('Product Price'), relation="product.product", string="Unit price", type="float"),
        'price_unit_out': fields.function(_get_unit_price_out, digits_compute= dp.get_precision('Product Price'), relation="product.product", type="float", string="Price in UoM of out move", 
